...
document.querySelector('.b-4').onclick = function () {
    document.querySelector('.out-4').textContent = t4(1996);
}
...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Dima');
}
...
// https://codepen.io/Miranovich_Alexey/pen/vYNJzdZ
// Task 7
...
function t7() {
    ...
    // let r = function () { return (Math.random() * 255) };
    // return "rgb(" + r() + "," + r() + "," + r() + ")";
    // console.log(r);
...
document.querySelector('.b-9').onclick = function () {
    document.querySelector('.out-9').textContent = t9(20);
}
